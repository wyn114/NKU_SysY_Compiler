...
#line 118 "expr_plus.y"
                           { printf("%f\n",(yyvsp[0].num));printf("%s\n",(yyvsp[-2].id));addSymbol((yyvsp[-2].id), (yyvsp[0].num)); (yyval.num) = (yyvsp[0].num);}
...
#line 129 "expr_plus.y"
          { printf("%s\n",(yyvsp[0].id));char* tmp = malloc(50*sizeof(char));strcpy(tmp, (yyvsp[0].id));(yyval.num) = getValue(tmp); }
